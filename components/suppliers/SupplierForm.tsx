...
type SupplierFormPayload = SupplierInput & { store_id: string };

interface SupplierFormProps {
  storeId: string;
  onSubmit: (data: SupplierFormPayload) => void;
  onCancel: () => void;
  isSubmitting: boolean;
}

export function SupplierForm({ storeId, onSubmit, onCancel, isSubmitting }: SupplierFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
